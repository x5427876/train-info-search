const List = (props) => {
    ...
    return (
        <>
            <div className='border-2 border-gray-300 grid grid-cols-6 w-[80vw] rounded-xl mx-auto my-2 py-3 px-3 sm:py-8 hover:shadow-inner hover:bg-blue-100'>
                <div className='flex mx-2 sm:mx-8 justify-start items-center col-span-3 lg:col-span-2'>
                    <a className='text-lg sm:text-2xl font-bold whitespace-nowrap'>{props.trainType}&nbsp;&nbsp;</a>
                    <a className='text-lg'>{props.trainNo}</a>
                </div>
                <div className='flex mx-4 sm:mx-24 justify-center items-center col-span-3 lg:col-span-2'>
                    <div className='flex items-center'>
                        <div className='mx-0 flex flex-col'>
                            ...
                            <a className='mx-2 whitespace-nowrap text-lg sm:text-2xl'>{props.fromTime}</a>
                        </div>
                        ...
                        <div className='mx-0 flex flex-col'>
                            ...
                            <a className='mx-2 whitespace-nowrap text-lg sm:text-2xl'>{props.toTime}</a>
                        </div>
                    </div>
                </div>
